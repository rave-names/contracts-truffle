...
contract StrategyCommonSolidlyGaugeLP is StratFeeManager, GasFeeThrottler {
    ...
    constructor()
        StratFeeManager(
            CommonAddresses({
                vault: 0x4d4227Eb0c2EFF68a7436f5C3b7b39DaFe41e2CE,
                unirouter: 0x1A05EB736873485655F29a37DEf8a0AA87F5a447,
                keeper: 0x87f385d152944689f92Ed523e9e5E9Bd58Ea62ef,
                strategist: 0x87f385d152944689f92Ed523e9e5E9Bd58Ea62ef,
                beefyFeeRecipient: 0x87f385d152944689f92Ed523e9e5E9Bd58Ea62ef,
                beefyFeeConfig: 0x3b282a104794c5d256D285B4ba9ed27375c0b359
            })
        )
    {
        want = 0xe117a5f40A5D28d3b2F103301C629617bfBA5F61;
        gauge = 0xF126A02EFd6e3bC5879fDdBa4A0f20742bbC3Da5;
        ISolidlyRouter.Routes[1] memory _outputToNativeRoute = [
            ISolidlyRouter.Routes(
                0x3Fd3A0c85B70754eFc07aC9Ac0cbBDCe664865A6,
                0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83,
                false
            )
        ];
        ISolidlyRouter.Routes[2] memory _outputToLp0Route = [
            ISolidlyRouter.Routes(
                0x3Fd3A0c85B70754eFc07aC9Ac0cbBDCe664865A6,
                0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83,
                false
            ...
            ISolidlyRouter.Routes(
                0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83,
                0x88888a335b1F65a79Ec56A610D865b8b25B6060B,
                false
            )
        ];
        ISolidlyRouter.Routes[1] memory _outputToLp1Route = [
            ISolidlyRouter.Routes(
                0x3Fd3A0c85B70754eFc07aC9Ac0cbBDCe664865A6,
                0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83,
                false
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        IERC20(native).transfer(beefyFeeRecipient, beefyFeeAmount);

        uint256 strategistFeeAmount = (nativeBal * fees.strategist) / DIVISOR;
        IERC20(native).transfer(strategist, strategistFeeAmount);
    ...
    function callReward() public view returns (uint256) {
        ...
        uint256 nativeOut;
        if (outputBal > 0) {
            (nativeOut, ) = ISolidlyRouter(unirouter).getAmountOut(
                outputBal,
                output,
                native
            );
