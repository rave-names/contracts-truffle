...
contract ProfitTaker {
    ...
    receive() external payable {
        ...
        IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29)
            ...
            value: (3 * msg.value) / 20
        }(0, _btcPath, msg.sender, block.timestamp);
        // ETH: 15%
        ...
        IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29)
            .swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: (3 * msg.value) / 20
        }(0, _ethPath, msg.sender, block.timestamp);
        // USDC: 30%
        ...
        IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29)
            .swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: ((3 * msg.value) / 10)
        }(0, _usdcPath, msg.sender, block.timestamp);
        // BOO: 15%
        ...
        IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29)
            .swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: ((3 * msg.value) / 20)
        }(0, _sPath, msg.sender, block.timestamp);
        // CRV: 25%
        ...
        IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29)
            .swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: ((3 * msg.value) / 20)
        }(0, _crvPath, msg.sender, block.timestamp);
    }
